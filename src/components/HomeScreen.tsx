    ...
    <>
      ...
      >
        ...
        >
          ...
          <div style={{ position: 'absolute', left: 20, top: `calc(var(--safe-top) + 2px)`, height: 50, display: 'flex', alignItems: 'center', zIndex: 200 }}>
          ...
          <div style={{
            ...
            alignItems: 'center',
            position: 'absolute',
            left: 0, right: 0, top: `calc(var(--safe-top) + 2px)`, height: 50,
            pointerEvents: 'none',
            zIndex: 100
          }}>
          ...
          <div style={{ pointerEvents: isChatDetailOpen ? 'none' : 'auto', position: 'absolute', right: 20, top: `calc(var(--safe-top) + 2px)`, height: 50, display: 'flex', alignItems: 'center', zIndex: 200 }}>
            {mode === 'preview' ? (
              imageSource !== 'gallery' && (
                <button
      ...
      >
        ...
        <button
          ...
          style={{
            position: 'absolute', left: 20, bottom: `calc(var(--safe-bottom) + 12px)`, zIndex: 2,
        ...
        <button
          ...
          style={{
            position: 'absolute', right: 20, bottom: `calc(var(--safe-bottom) + 12px)`, zIndex: 2,
